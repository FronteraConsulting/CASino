...
describe CASino::AuthTokenValidationService do
  ...
  context 'with activerecord-based token signers' do
    ...
    before(:each) do
      ...
      FactoryGirl.create(:auth_token_signer, public_key_pem_content: signer_path_content)
  ...
  context 'with file-based token signers' do
